            ...
            <div className=" container row g-5">
                                ...
                                return <>
                                    <li key={i} className="list-group-item d-flex justify-content-between lh-sm">
                                        <div>
                                            ...
                                            <span><small className="text-muted">Size: {currElem.size} </small></span>
                ...
                <div className=" container col-md-6 col-lg-7">
                    ...
                    <form className="needs-validation" noValidate>
                        ...
                        <hr className="my-4" />
                        <NavLink to="/Checkout"><button className="w-100 btn btn-primary btn-lg" type="button" onClick={checkOut}>Continue to checkout</button></NavLink>
                    </form>
                </div>
            </div>
        </div>
